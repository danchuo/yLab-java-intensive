...
/**
 * The `AuditController` class is a Spring MVC controller responsible for handling HTTP requests
 * related to audit logs. It exposes an endpoint for retrieving audit logs in JSON format.
 */
@Timed
@RestController
